...
export default function CreateUltimatePage() {
  ...
  function submit(event: React.FormEvent<HTMLFormElement>) {
    ...
    localStorage.setItem("wakarite_question_bank", "ultimate");
    ...
    <AppShell showCreateButton={false}>
      <Card className="space-y-6">
        <div className="space-y-2">
          <p className="text-sm font-black text-orange-500">ULTIMATE MODE</p>
          <h1 className="text-3xl font-black leading-tight">究極の2択ワカリテを作ろう</h1>
          <img
          ...
          <p className="font-bold leading-7 text-slate-600">
            恋愛、人生、お金、もしもの選択など、本人も悩みそうな究極の2択でワカリテ診断を作れます。
          </p>
        </div>
        <form onSubmit={submit} className="space-y-4">
          <label className="grid gap-2 text-sm font-black">
            ...
            <input
              ...
              maxLength={20}
              placeholder="例：ワカリテ"
              className="min-h-14 rounded-2xl border border-slate-200 bg-white px-4 text-base font-bold outline-none transition focus:border-orange-300 focus:ring-4 focus:ring-orange-100"
            />
          </label>
