...
create table if not exists public.quizzes (
  ...
  bank_type text not null default 'standard' check (bank_type in ('standard', 'vtuber', 'private', 'ultimate')),
...
begin
  ...
  alter table public.quizzes
    add constraint quizzes_bank_type_check check (bank_type in ('standard', 'vtuber', 'private', 'ultimate'));
exception
